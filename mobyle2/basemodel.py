...
from mobyle2.utils import _, normalizeId
...
def acl_for_role_proxy_factory(self, rolename, acluser, aclgroup):
    ...
    class Proxy:
        ...
        @property
        def role(self):
            from mobyle2.models.auth import Role
...
class SecuredObject(Traversable):
    ...
    Note that it uses mobyle2 rolenaming scheme (resourcetype_rolename registration in the 'R' dict)
...
default_permissions = {
    ...
    P['servers_management']: _('Server management'),
    P['services_management']: _('Service management'),
...
default_acls = {
    ...
    P['servers_management']:{R['project_watcher'] : F, R['project_contributor'] : F, R['anonyme'] : F, R['internal_user'] : F, R['external_user'] : F, R['project_owner'] : F, R['project_manager'] : F, R['portal_administrator'] : T,},
    P['services_management']:{R['project_watcher'] : F, R['project_contributor'] : F, R['anonyme'] : F, R['internal_user'] : F, R['external_user'] : F, R['project_owner'] : F, R['project_manager'] : F, R['portal_administrator'] : T,},
