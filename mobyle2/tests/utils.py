...
from mobyle2.models import root
from mobyle2.models.init import initialize_sql
...
def get_app():
    from mobyle2.tests.utils import __wsgiapp__
    if not __wsgiapp__:
...
def get_session():
    from mobyle2.tests.utils import __session__
    if not __session__:
...
class PyramidLayer:
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.config.include('mobyle2.webserver') 
