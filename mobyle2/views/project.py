...
from mobyle2.basemodel import P
from mobyle2.views import Base, get_base_params
from mobyle2.utils import _
from mobyle2 import widget
from mobyle2.models import (
    project,
    user,
    auth as a,
...
SERVICE_STYLES_DIR = pkg_resources.resource_filename('mobyle2', 'static/service_styles')
R = a.R
J = os.path.join
