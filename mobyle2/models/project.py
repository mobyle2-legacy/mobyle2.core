...
from mobyle2.basemodel import P, R, SecuredObject
from mobyle2.models import Base, DBSession as session
from mobyle2.utils import _, mobyle2_settings, normalizeId
from mobyle2.models.server import Server, ProjectServer
from mobyle2.models.service import Service
...
class Project(Base):
    ...
    def get_public_project(cls):
        ...
        from mobyle2.models import user
