...
from mobyle2.models import initialize_sql
from mobyle2.models.auth import AuthenticationBackend
...
def velruse_config(config):
    ...
    settings['velruse.openid.store'] = 'mobyle2.velruse.get_sqlstore'
